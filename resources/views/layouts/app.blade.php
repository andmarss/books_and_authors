...
<head>
    ...
    <title>@yield('title', 'Self Publishing')</title>
...
{{--                                </div>--}}
                            ...
                            <div class="absolute z-30 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                                <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                                    <div class="pt-5 pb-6 px-5">
                                        ...
                                        <div class="mt-6">
                                            <nav class="grid grid-cols-1 gap-7">
                                                <router-link exact tag="h3" :to="{name: 'authors.index'}" class="cursor-pointer text-base font-medium text-gray-900 hover:text-gray-700">
                                                    Авторы
                                                </router-link>

                                                <router-link exact tag="h3" :to="{name: 'genres.index'}" class="cursor-pointer text-base font-medium text-gray-900 hover:text-gray-700">
                                                    Жанры
                                                </router-link>
                                            </nav>
                                        </div>
                                    ...
                                    <div class="py-6 px-5">
                                        <div class="mt-6">
                                            <router-link exact tag="h3" :to="{name: 'login'}" class="cursor-pointer w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                                                Войти
                                            </router-link>
                                            <p class="mt-6 text-center text-base font-medium text-gray-500">
                                                <router-link exact tag="h3" :to="{name: 'register'}" class="cursor-pointer text-gray">
                                                    Зарегистрироваться
                                                </router-link>
                                            </p>
                                        </div>
            ...
            <div data-testid="content" class="mx-auto">
                @yield('content')
            </div>
        </div>
    </div>
...
<script>
    window.site = {!! json_encode([
        'baseUrl' => url('/'),
        'routes' => collect(\Route::getRoutes())->mapWithKeys(function ($route) { return [$route->getName() => $route->uri()]; })->all()
    ]) !!}
</script>

<script src="{{asset('js/app.js')}}?t={{time()}}" ></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/js/toastr.min.js"></script>
<script src="https://kit.fontawesome.com/0927dce717.js" crossorigin="anonymous"></script>
